...
•	Terraform Symbols  
•	6 Dice
•	18 Action Markers  **is this right?**
...
In this phase, players bid resources to claim exploration rights and determine turn order.  
At the beginning of each round, each player draws and reveals a tile from the bag.
Each player secretly decides how many resources they are willing and able to pay.  All players reveal their bids simultaneously.  Place your die with the amount bid face-up on the "Bid" section on the board.  If multiple players bid the same amount, those players roll their die to break the tie.  The player in the highest "Bid" slot chooses their placement in the turn order, and moves their die to the matching "Turn" section on the board.  They then choose which tile they wish to place.  If you choose an opponent's tile, you pay the next lowest bid to that player.  If you choose your own tile, pay the next lowest bid to the bank.  Place the tile on your role card.
...
At the start of your turn, choose where to place the tile you selected in the previous phase.  The tile must be placed on an unexplored space. Exploration must be done in the blue zone until there are 3 or fewer blue spaces left unexplored.
The player may choose to place planet tiles with either side face up. If the player places a destroyed planet tile, they may collect any resource from the bank.
Each round, you may take 1 base action, 1 research action, and 1 additional action of your choice, in any order.  Place your action marker on the action of your choice, and pay any additional required costs. 
Finalize all effects from an action before taking your next action. Some technologies cause slight changes in the base actions.  You may take multiple actions of one type.
...
**_Build Fleet_** - You may build a fleet on your colonized planet tile with a military symbol, up to the level of the colony.  If there is already a fleet on this tile, it is destroyed.
...
You may move your fleet into an unexplored space and draw 1 tile to explore it.  This immediately ends your move action. (Note: The outer spaces, indicated by the white zone, may be explored this way at any time. They are not restricted as during the bidding/exploration phases). If you place a destroyed planet tile, your fleet is immediately destroyed.

**_Attacking_** - 
On your move action, if your fleet enters a tile occupied by an opponent's fleet and/or colony, you attack.

To win an attack, you must have a higher offensive strength than your opponent's defensive strength (a tie goes to the defender). Fleet and colony strength is equal to their level.
...
**_Supporting_** - 
You may spend 1⚛ to support per adjacent fleet. Supporting fleets add their level to your strength. You may support on your turn as part of the attack, or spend the required ⚛ as defense if attacked. Supporting fleets do not move, and thus are not destroyed if they fail.
...
**_Research_** - You may research a technology by paying the associated cost. Flip the tech card over to the colored side to indicate it has been activated. Effects from technologies researched may be used immediately.

Some technologies also require you to have researched a prerequisite technology. This is indicated on the unpurchased side in the "Requires" box.

If you choose to research a technology that is mutually exclusive with one you have already researched, you lose the benefits from the older technology and must remove it from your role card.  Mutually exclusive technologies are indicated in the "Negates" box.
...
When any player has fewer than 3 colonies remaining in their supply, complete the current round, and play a final round.  
If any player has been eliminated (no colonies or fleets left on the board), finish the current round.
